function generateData() {
  ...
  for (let i = 1; i <= 100; i++) {
    ...
    // 3, 6, 9월 모의고사 성적 추이용 데이터
    mocks.push(
      { 시행년월: "2026-03", 학번: stId, 영역: "국어", 표준점수: (110 + (i % 20)).toString(), 백분위: (80 + (i % 15)).toString(), 등급: ((i % 3) + 2).toString(), 학교내석차: ((i % 15) + 1).toString() },
      { 시행년월: "2026-06", 학번: stId, 영역: "수학", 표준점수: (118 + (i % 22)).toString(), 백분위: (85 + (i % 12)).toString(), 등급: ((i % 3) + 1).toString(), 학교내석차: ((i % 12) + 1).toString() },
      { 시행년월: "2026-09", 학번: stId, 영역: "영어", 표준점수: (125 + (i % 18)).toString(), 백분위: (90 + (i % 8)).toString(), 등급: "1", 학교내석차: ((i % 8) + 1).toString() }
    );
